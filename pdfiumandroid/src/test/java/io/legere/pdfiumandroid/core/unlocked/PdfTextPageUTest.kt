...
abstract class PdfTextPageBaseTest : ClosableTestContext {
    ...
    fun textPageGetCharBox_validIndex() =
        closableTest {
            ...
            verifyHappy {
                assertThat(it).isEqualTo(KtImmutableRectF(90.0f, 700.0f, 100.0f, 600.0f))
            }
            verifyDefault {
                assertThat(it).isNull()
            }
    ...
    fun textPageGetRectsForRanges_validInput() =
        closableTest {
            ...
            verifyHappy {
                ...
                assertThat(it!![0].rect).isEqualTo(KtImmutableRectF(10f, 20f, 30f, 40f))
            }
            verifyDefault {
                assertThat(it).isNull()
            }
    ...
    fun textPageGetBoundedText_validRect() =
        closableTest {
            ...
            apiCall = {
                pdfTextPage.textPageGetBoundedText(KtImmutableRectF(0f, 0f, 100f, 100f), 10)
            }
...
class PdfTextPageHappyPathTest : PdfTextPageBaseTest() {
    ...
    fun `textPageGetCharBox native order correction`() {
        ...
        // KtImmutableRectF (left, top, right, bottom) for a valid character index.
        every { mockNativeTextPage.textGetCharBox(any(), any()) } returns
            doubleArrayOf(
                90.314415,
                103.44171,
        ...
        assertThat(rect).isEqualTo(KtImmutableRectF(90.314415f, 715.3187f, 103.44171f, 699.1206f))
    }
