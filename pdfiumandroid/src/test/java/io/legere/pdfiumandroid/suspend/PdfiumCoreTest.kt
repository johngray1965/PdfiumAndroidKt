...
class PdfiumCoreTest {
    private lateinit var core: PdfiumCoreKt
    ...
    fun newDocument() =
        runTest {
            ...
            val result = core.newDocument(parcelFileDescriptor)
    ...
    fun testNewDocument() =
        runTest {
            ...
            val result = core.newDocument(parcelFileDescriptor, "password")
            assertThat(result.document).isEqualTo(document)
    ...
    fun testNewDocument1() =
        runTest {
            ...
            val result = core.newDocument(data)
            assertThat(result.document).isEqualTo(document)
    ...
    fun testNewDocument2() =
        runTest {
            ...
            val result = core.newDocument(data, "password")
            assertThat(result.document).isEqualTo(document)
    ...
    fun testNewDocument3() =
        runTest {
            ...
            val result = core.newDocument(pdfiumSource)
            assertThat(result.document).isEqualTo(document)
