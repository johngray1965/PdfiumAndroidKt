...
interface PdfiumSource {
     ...
     * @param buffer the buffer to read data into. Always have enough space to read [size] bytes. It should be filled starting from index 0.
     ...
     */
    fun read(position: Long, buffer: ByteArray, size: Int): Int
