...
class PdfMatrixPrePostTest {
    ...
    fun preRotate(angle: Double) {
        val start = PdfMatrix().setTranslate(50.0, 50.0).setScale(0.5, 0.5)
        ...
        assertThat(rotated.values).usingTolerance(0.001).containsExactly(alt.values)
    }

    fun preRotateWithOffset(angle: Double) {
        val start = PdfMatrix().setTranslate(50.0, 50.0).setScale(0.5, 0.5, 25.0, 25.0)
    ...
    fun postRotateWithOffset(angle: Double) {
        val start = PdfMatrix().setTranslate(50.0, 50.0).setScale(0.5, 0.5, 25.0, 25.0)
    ...
    @Test
    fun preScale() {
        val start = PdfMatrix().setTranslate(50.0, 50.0).setRotate(90.0)
    ...
    fun preScaleWithOffset() {
        val start = PdfMatrix().setTranslate(50.0, 50.0).setRotate(90.0, 25.0, 25.0)
    ...
    fun postSkew() {
        ...
        assertThat(rotated).isEqualTo(alt)
    }
    ...
    @Test
    fun preTranslate() {
        val start = PdfMatrix().setRotate(90.0).setScale(0.5, 0.5)
