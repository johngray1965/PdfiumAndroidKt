...
class PdfRectTest {
    ...
    fun inset00() {
        ...
        assertThat(result2).isEqualTo(PdfRect(left = 0, top = 10, right = 10, bottom = 0))
        val result3 = result2.inset(10, 0)
        assertThat(result3).isEqualTo(PdfRect(left = 10, top = 10, right = 0, bottom = 0))
    }
    ...
    fun intersectAEmpty() {
        val rect1 = PdfRect()
        val rect2 = PdfRect(5, 5, 15, 15)
        val expected = PdfRect()
        val result = rect1.intersect(rect2)
        assertThat(result).isEqualTo(expected)
        val result2 = rect2.intersect(rect1)
        assertThat(result2).isEqualTo(PdfRect(5, 5, 15, 15))
    }
    ...
    fun union() {
        ...
        assertThat(emptyRect.union(MutablePdfRect(0, 0, 10, 10))).isEqualTo(PdfRect(0, 0, 10, 10))
    }
    ...
    fun unionEmpty() {
        ...
        val emptyRect = PdfRect()
        val result2 = rect2.union(emptyRect)
        assertThat(result2).isEqualTo(result)
        val result3 = PdfRect().union(rect1)
    ...
    fun isEmpty() {
        ...
        assertThat(PdfRect(0, 0, -5, -5).isEmpty).isTrue()
        assertThat(PdfRect(0, 0, 1, -5).isEmpty).isTrue()
    }
